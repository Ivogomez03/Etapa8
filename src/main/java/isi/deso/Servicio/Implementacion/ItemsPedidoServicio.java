...
public class ItemsPedidoServicio {
    ...
    public List<ItemsPedido> buscarPorVendedor(String dni) throws ItemNoEncontradoException {
        ...
        if (lista.isEmpty())
            throw new ItemNoEncontradoException("No se ha encontrado items para el vendedor con dni " + dni);

        return lista;
    }

    public List<ItemsPedido> buscarPorCliente(String cuit) throws ItemNoEncontradoException {
        ...
        if (lista.isEmpty())
            throw new ItemNoEncontradoException("No se ha encontrado items para el cliente con cuit " + cuit);
